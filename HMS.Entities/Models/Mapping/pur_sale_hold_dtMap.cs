...
{
    public class pur_sale_hold_dtMap : EntityTypeConfiguration<pur_sale_hold_dt>
    {
        public pur_sale_hold_dtMap()
        {
            // Primary Key
