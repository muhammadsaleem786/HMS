...
{
    public class pur_sale_hold_mfMap : EntityTypeConfiguration<pur_sale_hold_mf>
    {
        public pur_sale_hold_mfMap()
        {
            // Primary Key
            ...
            this.ToTable("pur_sale_hold_mf");
            this.Property(t => t.ID).HasColumnName("ID");
            this.Property(t => t.CompanyID).HasColumnName("CompanyID");
            this.Property(t => t.Date).HasColumnName("Date");
            this.Property(t => t.SubTotal).HasColumnName("SubTotal");
            this.Property(t => t.HoldStatus).HasColumnName("HoldStatus");
            ...
            this.HasOptional(t => t.adm_user_mf1)
                .WithMany(t => t.pur_sale_hold_mf1)
