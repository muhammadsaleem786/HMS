...
{
    public interface Iadm_integrationService : IService<adm_integration>
    {
    ...
    public class adm_integrationService : Service<adm_integration>, Iadm_integrationService
    {
        private readonly IRepositoryAsync<adm_integration> _repository;
        public adm_integrationService(IRepositoryAsync<adm_integration> repository) : base(repository)
        {
