...
{
    public interface Iadm_role_dtService : IService<adm_role_dt>
    {
    ...
    public class adm_role_dtService : Service<adm_role_dt>, Iadm_role_dtService
    {
        private readonly IRepositoryAsync<adm_role_dt> _repository;
        public adm_role_dtService(IRepositoryAsync<adm_role_dt> repository) : base(repository)
        {
