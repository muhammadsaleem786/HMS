...
namespace HMS.Service.Services.Admin
{
    ...
    public interface Isys_notification_alertService : IService<sys_notification_alert>
    {
    ...
    public class sys_notification_alertService : Service<sys_notification_alert>, Isys_notification_alertService
    {
        private readonly IRepositoryAsync<sys_notification_alert> _repository;
        public sys_notification_alertService(IRepositoryAsync<sys_notification_alert> repository) : base(repository)
        {
