...
{
    public interface Iipd_admission_labService : IService<ipd_admission_lab>
    {
    ...
    public class ipd_admission_labService : Service<ipd_admission_lab>, Iipd_admission_labService
    {
        private readonly IRepositoryAsync<ipd_admission_lab> _repository;
        public ipd_admission_labService(IRepositoryAsync<ipd_admission_lab> repository) : base(repository)
        {
