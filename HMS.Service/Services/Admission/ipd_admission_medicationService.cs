...
{
    public interface Iipd_admission_medicationService : IService<ipd_admission_medication>
    {
    ...
    public class ipd_admission_medicationService : Service<ipd_admission_medication>, Iipd_admission_medicationService
    {
        private readonly IRepositoryAsync<ipd_admission_medication> _repository;
        public ipd_admission_medicationService(IRepositoryAsync<ipd_admission_medication> repository) : base(repository)
        {
