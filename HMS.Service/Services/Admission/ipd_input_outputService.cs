...
{
    public interface Iipd_input_outputService : IService<ipd_input_output>
    {
    ...
    public class ipd_input_outputService : Service<ipd_input_output>, Iipd_input_outputService
    {
        private readonly IRepositoryAsync<ipd_input_output> _repository;
        public ipd_input_outputService(IRepositoryAsync<ipd_input_output> repository) : base(repository)
        {
