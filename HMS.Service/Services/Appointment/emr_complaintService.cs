...
namespace HMS.Service.Services.Appointment
{
    ...
    public interface Iemr_complaintService : IService<emr_complaint>
    {
    ...
    public class emr_complaintService : Service<emr_complaint>, Iemr_complaintService
    {
        private readonly IRepositoryAsync<emr_complaint> _repository;
        public emr_complaintService(IRepositoryAsync<emr_complaint> repository) : base(repository)
        {
