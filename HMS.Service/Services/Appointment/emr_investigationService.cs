...
namespace HMS.Service.Services.Appointment
{
    ...
    public interface Iemr_investigationService : IService<emr_investigation>
    {
    ...
    public class emr_investigationService : Service<emr_investigation>, Iemr_investigationService
    {
        private readonly IRepositoryAsync<emr_investigation> _repository;
        public emr_investigationService(IRepositoryAsync<emr_investigation> repository) : base(repository)
        {
