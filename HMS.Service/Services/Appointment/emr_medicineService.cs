...
namespace HMS.Service.Services.Appointment
{
    ...
    public interface Iemr_medicineService : IService<emr_medicine>
    {
    ...
    public class emr_medicineService : Service<emr_medicine>, Iemr_medicineService
    {
        private readonly IRepositoryAsync<emr_medicine> _repository;
        public emr_medicineService(IRepositoryAsync<emr_medicine> repository) : base(repository)
        {
