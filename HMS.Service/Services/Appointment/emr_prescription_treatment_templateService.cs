...
namespace HMS.Service.Services.Appointment
{
    ...
    public interface Iemr_prescription_treatment_templateService : IService<emr_prescription_treatment_template>
    {
    ...
    public class emr_prescription_treatment_templateService : Service<emr_prescription_treatment_template>, Iemr_prescription_treatment_templateService
    {
        private readonly IRepositoryAsync<emr_prescription_treatment_template> _repository;
        public emr_prescription_treatment_templateService(IRepositoryAsync<emr_prescription_treatment_template> repository) : base(repository)
        {
