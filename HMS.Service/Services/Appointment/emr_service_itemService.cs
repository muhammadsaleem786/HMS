...
{ 
    public interface Iemr_service_itemService : IService<emr_service_item>
    {
    ...
    public class emr_service_itemService : Service<emr_service_item>, Iemr_service_itemService
    {
        private readonly IRepositoryAsync<emr_service_item> _repository;
        public emr_service_itemService(IRepositoryAsync<emr_service_item> repository) : base(repository)
        {
