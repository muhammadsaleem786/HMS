...
{
    public interface Ipr_departmentService : IService<pr_department>
    {
    ...
    public class pr_departmentService : Service<pr_department>, Ipr_departmentService
    {
        private readonly IRepositoryAsync<pr_department> _repository;
        public pr_departmentService(IRepositoryAsync<pr_department> repository) : base(repository)
        {
