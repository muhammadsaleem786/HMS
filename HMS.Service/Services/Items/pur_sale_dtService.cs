...
namespace HMS.Service.Services.Items
{
    ...
    public interface Ipur_sale_dtService : IService<pur_sale_dt>
    {
    ...
    public class pur_sale_dtService : Service<pur_sale_dt>, Ipur_sale_dtService
    {
        private readonly IRepositoryAsync<pur_sale_dt> _repository;
        public pur_sale_dtService(IRepositoryAsync<pur_sale_dt> repository) : base(repository)
        {
