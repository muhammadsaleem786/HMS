...
namespace HMS.Service.Services.Items
{
    ...
    public interface Ipur_sale_hold_mfService : IService<pur_sale_hold_mf>
    {
    ...
    public class pur_sale_hold_mfService : Service<pur_sale_hold_mf>, Ipur_sale_hold_mfService
    {
        private readonly IRepositoryAsync<pur_sale_hold_mf> _repository;
        public pur_sale_hold_mfService(IRepositoryAsync<pur_sale_hold_mf> repository) : base(repository)
        {
