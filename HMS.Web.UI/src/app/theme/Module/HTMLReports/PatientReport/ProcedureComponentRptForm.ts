...
@Component({
    selector: 'ProcedureComponentRptForm',
    templateUrl: 'ProcedureComponentRptForm.html',
    moduleId: module.id,
    providers: [ReportService],
})
export class ProcedureComponentRptForm implements OnInit {
    ...
    LoadProcedure() {
        $("#ProcedureSearchByName").autocomplete({
            source: (request, response) => {
                this.loader.ShowLoader();
                this.reportservice.ServiceSearch(request.term).then(m => {
                    response(m.ResultSet.serviceInfo);
    ...
    RunReport() {
        ...
        this.reportservice.ProcedureRpt(this.model).then(m => {
