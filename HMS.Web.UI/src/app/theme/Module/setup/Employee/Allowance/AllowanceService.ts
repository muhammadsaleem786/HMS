...
export class AllowanceService {
    ...
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Employee/pr_allowance"
    ...
    SaveOrUpdate(entity: AllowanceModel): Promise<any> {
    ...
    SaveAndReturnList(entity: AllowanceModel): Promise<any> {
        return this.http.Post(this.urlToApi + '/SaveAndReturnList', entity).then(e => e);
    }

    SaveAndReturnAllowance(entity: AllowanceModel): Promise<any> {
        return this.http.Post(this.urlToApi + '/SaveAndReturnAllowance', entity).then(e => e);
    }
