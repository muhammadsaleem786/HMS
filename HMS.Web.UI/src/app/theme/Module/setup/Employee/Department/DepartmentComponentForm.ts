...
export class DepartmentComponentForm implements OnInit, OnChanges {
    ...
    constructor(public _fb: FormBuilder, public loader: LoaderService
        , public _DepartmentService: DepartmentService, public toastr: CommonToastrService, private encrypt: EncryptionService,
        public commonservice: CommonService) {
        this.Rights = JSON.parse(this.encrypt.decryptionAES(localStorage.getItem('Rights')));
        this.ControlRights = this.commonservice.ScreenRights("53");
    }
