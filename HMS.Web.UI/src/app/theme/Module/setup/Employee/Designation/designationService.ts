...
export class designationService {
    ...
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Employee/pr_designation"
    ...
    SaveOrUpdate(entity: designationModel): Promise<any> {
    ...
    SaveAndReturnDesignationList(entity: designationModel): Promise<any> {
        return this.http.Post(this.urlToApi + '/SaveAndReturnDesignationList', entity).then(e => e);
    }
