...
export class holidayService {
    ...
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Employee/sys_holidays"
    ...
    SaveOrUpdate(entity: holidayModel): Promise<any> {
    ...
    SaveAndReturnDeptList(entity: holidayModel): Promise<any> {
