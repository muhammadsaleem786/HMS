...
export class PayscheduleService {
    ...
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Employee/pr_payschedule"
  ...
  SaveOrUpdate(entity: Payschedule): Promise<any> {
  ...
  SaveAndReturnPayScheduleList(entity: Payschedule): Promise<any> {
      return this.http.Post(this.urlToApi + '/SaveAndReturnPayScheduleList', entity).then(e => e);
  }
