...
@Injectable()
export class VacationSickLeaveService {


    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Employee/pr_leave_type"
    ...
    SaveOrUpdate(entity: VacationSickLeaveModel): Promise<any> {
    ...
    SaveAndReturnLeaveTypeList(entity: VacationSickLeaveModel): Promise<any> {
        return this.http.Post(this.urlToApi + '/SaveAndReturnLeaveTypeList', entity).then(e => e);
    }
