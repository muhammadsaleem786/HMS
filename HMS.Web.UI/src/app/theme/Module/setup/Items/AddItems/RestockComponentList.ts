...
@Component({
    moduleId: module.id,
    templateUrl: 'RestockComponentList.html',
    providers: [ItemService],
})
export class RestockComponentList {
    ...
    ngOnInit() {
        ...
        this.PConfig.Fields = [
            ...
            { Name: "MinimumQuantity", Title: "Minimum Level", OrderNo: 4, SortingAllow: true, Visible: true, isDate: false, DateFormat: "" },            
            { Name: "Stock", Title: "Stock", OrderNo: 5, SortingAllow: true, Visible: true, isDate: false, DateFormat: "" },
        ];
    }
    Refresh() {
        ...
        this.Id = "0";
        this._ItemService
            .GetRestockItemList(this.PModel.CurrentPage, this.PModel.RecordPerPage, this.PModel.VisibleColumnInfo, this.PModel.SortName, this.PModel.SortOrder,this.PModel.SearchText, this.PModel.FilterID).then(m => {
