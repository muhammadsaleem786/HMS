...
export class PaymentService {
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Admin/pur_payment";
    ...
    GetList(CurrentPage: number, RecordPerPage: number, VisibleColumnInfo: string, SortName: string, SortOrder: string, SearchText: string, FilterID: string): Promise<any> {
    ...
    SaveOrUpdate(entity: PaymentModel): Promise<any> {
