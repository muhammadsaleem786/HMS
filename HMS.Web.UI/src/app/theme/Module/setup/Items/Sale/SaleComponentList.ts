...
@Component({
    moduleId: module.id,
    templateUrl: 'SaleComponentList.html',
    providers: [SaleService],
})
export class SaleComponentList {
    ...
    constructor(public _CommonService: CommonService, public loader: LoaderService
        , public _router: Router, public _SaleService: SaleService, public _fb: FormBuilder
    ...
    AddRecord(id: string) {
        if (id != "0") {
            //let ReturnInvoice = this.InvoiveList.filter(a => a.ReturnInvoiceId === id);
        ...
        this._AsidebarService.SetSaleHoldValue('0');
        this.Id = id;
        this.IsList = false;
