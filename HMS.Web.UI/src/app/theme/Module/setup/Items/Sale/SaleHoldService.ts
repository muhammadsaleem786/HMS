...
import { SaleModel, SaleHoldModel } from './SaleModel';
import { GlobalVariable } from '../../../../../AngularConfig/global';
import { HttpService } from '../../../../../CommonService/HttpService';
@Injectable()
export class SaleHoldService {

    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Admin/pur_sale_hold_mf"
    ...
    SaveOrUpdate(entity: SaleHoldModel): Promise<any> {
    ...
    UpdateSaleHoldStatus(Id: string): Promise<any> {
        var data = { 'Id': Id };
        return this.http.Get(this.urlToApi + '/UpdateSaleHoldStatus', data).then(e => e);
    }
    SaleHoldDelete(): Promise<any> {
        return this.http.Delete(this.urlToApi + '/SaleHoldDelete', {}).then(e => e);
    }
