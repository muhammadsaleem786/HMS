...
import { emr_service_mf, emr_service_item } from './ServiceModel';
@Injectable()
export class Service {
    private urlToApi = GlobalVariable.BASE_Api_URL + "/api/Appointment/emr_service_mf"
    ...
    SaveOrUpdate(entity: emr_service_mf): Promise<any> {
    ...
    searchService(term: string): Promise<any> {
        var data = { 'term': term };
        return this.http.Get(this.urlToApi + '/searchService', data).then(e => e);
    }
}
